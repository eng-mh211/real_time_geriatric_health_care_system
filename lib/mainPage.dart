...
class _main_pageState extends State<main_page> {
  ...
  void initState() {
    ...
    _BPMRef.onValue.listen((event) {
      setState(() {
        _BPM = event.snapshot.value as double;
      });
    });

    _Spo2Ref.onValue.listen((event) {
      setState(() {
        _Spo2 = event.snapshot.value as double;
      });
    });
  }
                  ...
                  Container(
                      ...
                      child: SfRadialGauge(axes: <RadialAxis>[
                        RadialAxis(minimum: 0, maximum: 100, ranges: <GaugeRange>[
                          GaugeRange(startValue: 0, endValue: 70, color: Colors.red),
                          GaugeRange(startValue: 70, endValue: 90, color: Colors.orange),
                          GaugeRange(startValue: 90, endValue: 100, color: Colors.green)
                        ], pointers: <GaugePointer>[
                          NeedlePointer(value: _Spo2)
                  ...
                  Container(
                      ...
                      child: SfRadialGauge(axes: <RadialAxis>[
                        RadialAxis(minimum: 0, maximum: 150, ranges: <GaugeRange>[
                          ...
                          GaugeRange(startValue: 80, endValue: 150, color: Colors.green)
                        ], pointers: <GaugePointer>[
                          NeedlePointer(value: _BPM)
                        ], annotations: <GaugeAnnotation>[
                          GaugeAnnotation(
                              widget: Container(
                                  child: Align(alignment: Alignment.center,
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 10,),
                    Text("Temputure : $_Temp",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),)
                  ],
                )
              )
            ],
